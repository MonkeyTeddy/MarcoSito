            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  topRight: Radius.circular(computeRightRadius()),
                  bottomRight: Radius.circular(computeRightRadius()),
                ),
              ),
              child: Padding(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  bottomRight:
                      Radius.circular(height != null ? height! / 2 : 6),
                ),
              ),
            ),
          ),
